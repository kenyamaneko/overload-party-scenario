...
func TestNew(t *testing.T) {
	t.Run("New の入力検証", func(t *testing.T) {
		...
		tests := []struct {
			...
			{
				name:      "onboarding-name-set topic 名が空のとき、all topic names are required エラーになる",
			...
			{
				name:      "onboarding-faction-set topic 名が空のとき、all topic names are required エラーになる",
				projectID: "test-project",
				override: func(topics *publisherTopics) {
			...
			{
				name:      "player-onboarded topic 名が空のとき、all topic names are required エラーになる",
				projectID: "test-project",
				override: func(topics *publisherTopics) {
